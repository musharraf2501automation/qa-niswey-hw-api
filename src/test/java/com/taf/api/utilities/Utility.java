...
public class Utility {
	...
	public static Response doRequest(RequestSpecification requestSpec) {
		...
		authHeader.put("authorization", Base.envProperties.getProperty("authToken"));
		...
		case "post":
			return requestSpec.headers(authHeader).log().all().relaxedHTTPSValidation()
		...
		case "delete":
			return requestSpec.headers(authHeader).log().all().relaxedHTTPSValidation().delete(getProperty(Constants.URL));
		case "patch":
